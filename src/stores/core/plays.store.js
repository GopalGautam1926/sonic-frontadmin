  ...
  fetchPlays(page = 1) {
    ...
    const options = {
      params: {
        ...
        "relation_filter": this.filters.userName ? { "$or": [{ "relation_sonicKey.owner._id": this.filters.userName }, { "createdBy": this.filters.userName }] } : undefined,
        "relation_sonicKey.partner._id": this.filters.partnerName || undefined,
        "relation_sonicKey.company._id": this.filters.companyName || undefined,
